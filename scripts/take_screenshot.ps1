<# 
  Vendored from C:\Users\Rebecca\.codex\skills\screenshot\scripts\take_screenshot.ps1.
  Keep behavior aligned with screenshot skill capture technique for UI test automation.
#>
